...
<div class="banner-bg about-bg">
	<p>YONSEI MAIN DENTAL CLINIC</p>
	<h2>문의사항</h2>
</div>
<?php
	include_once(G5_PATH.'/notice_nav.php');
?>
<script>
	$(document).ready(function(){
		$('.sub-menu02').prev().html('문의사항');
	});
</script>
...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>" class="inner">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <!-- <th scope="col" class="th_tel">연락처</th> -->
            <th scope="col" class="th_data"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜</a></th>
